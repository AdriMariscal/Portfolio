...
published: true
date: 2025-12-30
image: "/images/blog/mac-with-vsc.jpg"
...
# Infraestructura como código sin drama: baseline dev/staging/prod con Terraform + GitHub Actions
...
![Diagrama conceptual de baseline dev/staging/prod con piezas comunes y variables por entorno](/images/blog/diagrama-infraestructura.png)
...
![Captura genérica de un job de GitHub Actions ejecutando terraform fmt/init/plan con checks en verde](/images/blog/laptop-on-wooden-table.jpg)

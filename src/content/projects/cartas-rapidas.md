...
beforeAfter:
  - metric: "Performance"
    ...
    source: "Lighthouse CI histórico (v0.2.5 → v2.35.0)"
  - metric: "LCP"
    before: "4.2 s"
    after: "1.4 s"
    improvement: "-67%"
  ...
  - metric: "INP"
    ...
    source: "Lighthouse CI histórico (v2.35.0)"
  - metric: "Bundle JS"
    before: "~380 KB"
    after: "~110 KB"
    improvement: "-71%"
  ...
  - metric: "Accessibility"
    ...
    after: "96"
    improvement: "+17 pts"
    description: "Puntuación Lighthouse Accessibility (umbral CI ≥ 90)"
    source: "Lighthouse CI histórico (v0.2.5 → v2.35.0)"
  - metric: "SEO"
    before: "75"
    after: "98"
    improvement: "+23 pts"
    description: "Puntuación Lighthouse SEO (umbral CI ≥ 90)"
    source: "Lighthouse CI histórico (v0.2.5 → v2.35.0)"
changelog:
  - version: v2.35.0
